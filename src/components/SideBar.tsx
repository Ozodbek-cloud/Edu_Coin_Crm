'use client'
import { UsersRound, GraduationCap, Layers3, BookText, Settings2, BookOpen, LocateFixed, Code2, Sparkles } from 'lucide-react'
  ...
  return (
    <div className=''>
      <section className='mt-4'>
        <div className='flex flex-col  w-[300px] justify-between h-[calc(99vh-100px)] shadow-md'>
          <div className='flex flex-col gap-2'>
            ...
            <div onClick={() => navigate.push('')} className='flex items-center gap-3 px-4 py-3  cursor-pointer border-white hover:bg-[#9400dd] hover:text-white rounded-2xl transition-all duration-200'>
              <Layers3 size={28} />
              <h1 className='text-[18px] font-medium'>Guruhlar</h1>
            </div>
